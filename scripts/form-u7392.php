...
{
	$to = 'laishi886@ljjl.com';
	$subject = '联系我吧 Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>名字:</b></td><td>' . htmlentities($_REQUEST["custom_U7422"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>回复信息:</b></td><td>' . htmlentities($_REQUEST["custom_U7393"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>你的电话:</b></td><td>' . htmlentities($_REQUEST["custom_U7403"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>公司:</b></td><td>' . htmlentities($_REQUEST["custom_U7411"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
